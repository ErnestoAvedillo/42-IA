...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Train a DQN agent for the Snake game.'
        )
    parser.add_argument('-l', '--learn_type',
                        type=str,
    ...
    parser.add_argument('--history_lengths',
                        type=str,
                        nargs='?', default='lengths.csv',
                        help=('File name to save the hystoric of'
                              ' lengths for each game played.'))
