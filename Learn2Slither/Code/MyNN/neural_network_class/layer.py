...
class Layer():
    ...
    def forward_calculation(self, X):
        self.output = self.layer.forward_calculation(X)
        return self.output
    
    def predict_output(self):
        return self.layer.predict_output(self.output)
    ...
    def evaluate_prediction(self, Y, y_calculated, y_predicted):
        return self.layer.evaluate_prediction(Y, y_calculated, y_predicted)
