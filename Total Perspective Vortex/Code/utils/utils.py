def get_classifiers_list():
    classifiers={
                ...
                "SVM_O_Vs_O":        "OneVsOneClassifier Suport Vector Machine (Linear)",
                "SVM_O_Vs_R":        "OneVsRestlassifier Suport Vector Machine (Linear)",
                "POLY_SVM":          "Suport Vector Machine (Polinomial)",
                "POLY_SVM_O_Vs_O":   "OneVsOneClassifier Suport Vector Machine (Polinomial)",
                "POLY_SVM_O_Vs_R":   "OneVsRestlassifier Suport Vector Machine (Polinomial)",
                "SIG_SVM":           "Suport Vector Machine  (Sigmoid)",
                "SIG_SVM_O_Vs_O":    "OneVsOneClassifier Suport Vector Machine (Sigmoid)",
                "SIG_SVM_O_Vs_R":    "OneVsRestlassifier Suport Vector Machine (Sigmoid)",
                "RF":                "Ranfom Forest",
                "RF_O_Vs_O":         "OneVsOneClassifier Ranfom Forest",
                "RF_O_Vs_R":         "OneVsRestlassifier Ranfom Forest",
                "LDA":               "Random Forest",
